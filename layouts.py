...
lay_circle = [[sg.Text('Circle')],
            [sg.Text('Enter Circle radius (mm)'), sg.InputText(key="radius_input")],
...
lay_rectangle = [[sg.Text('Rectangle')],
            [sg.Text('Enter X length (mm)'), sg.InputText(key="x length")],
            [sg.Text('Enter Y length (mm)'), sg.InputText(key='y length')],
...
lay_draw = [[sg.Text('Drawing Parameters')],
            [sg.Text('Enter X length (mm)'), 
             sg.InputText(key="x draw length")],
            [sg.Text('Enter Y length (mm)'), sg.InputText(key='y draw length')],
            [sg.Button("Start Drawing")]
            ]

'''                               
                                ***************
                        General Shape Configuration Layout
                                ***************
'''

lay_shapeChoice = [[sg.Text('Choose a shape:')],
                   [sg.Text("X Margin:", key = "XMargin"), 
                    sg.Text("Y Margin:", key = "YMargin")],
          ...
          [sg.Button('OK'),sg.Button('Cancel'), sg.Button('Recalibrate')]]
...
lay_cut = [[sg.Text('Ready to Cut:')],
          [sg.Button('Go to Start'),
           ...
           sg.Button("New Shape"),
           sg.Button("Cancel")],
          [sg.Text("Speed Slider (Delay between steps in ms)"), sg.Slider(range=(0.1,1), default_value=1, resolution = 0.01, 
